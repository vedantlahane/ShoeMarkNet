...
const MainLayout = () => {
  ...
  return (
    <>
      <div className="relative flex min-h-screen max-w-screen flex-col overflow-y-scroll bg-white text-slate-900 transition-colors duration-300 dark:bg-slate-950 dark:text-slate-100 ">
