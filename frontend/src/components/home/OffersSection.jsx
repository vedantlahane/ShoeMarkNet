  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-0" aria-hidden="true">
        ...
        ></div>
        <div
          className={`absolute top-1/3 right-24 h-14 w-36 rounded-2xl border border-white/20 bg-white/10 backdrop-blur ${floatClass}`}
          style={{ animationDelay: "0.7s" }}
        ></div>
        <div
          className={`absolute bottom-24 left-1/4 h-10 w-10 rounded-full border border-white/10 bg-white/10 ${floatClass}`}
            ...
            return (
              <Link
                ...
                className={`group relative block overflow-hidden rounded-3xl border ${
                  isActive
                    ? "border-blue-400/50 shadow-[0_20px_45px_-20px_rgba(37,99,235,0.45)]"
                    : "border-blue-100/40 dark:border-slate-800/60 shadow-[0_15px_35px_-25px_rgba(15,23,42,0.9)]"
              ...
              >
                ...
                <div className="p-6 lg:p-8">
                  <h3 className="relative text-xl lg:text-2xl font-bold text-gray-900 dark:text-white mb-3 transition-colors duration-300 group-hover:text-blue-600 dark:group-hover:text-blue-400">
                    <span
                      className={`relative inline-block after:absolute after:left-0 after:bottom-[-6px] after:h-[2px] after:bg-gradient-to-r from-blue-500 to-purple-500 after:transition-all after:duration-300 after:w-0 after:opacity-0 ${underlineClass}`}
                    >
                      {offer.title}
                    </span>
                  </h3>
