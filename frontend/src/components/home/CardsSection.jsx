...
const SIZE_VARIANTS = {
  ...
  tall: "md:col-span-1 md:row-span-2 xl:col-span-1 xl:row-span-1", // reduced row-span to 1 for xl
...
const CardSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto sm:w-11/12 lg:w-4/5  px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="mt-4 text-base md:text-lg text-gray-700 dark:text-slate-200/80">
            ...
            handpicked to elevate your sneaker game.
          </p>
        </div>
                    ...
                    <div className="relative flex-1 overflow-hidden">
                      ...
                      <div
                        className={`absolute inset-0 bg-gradient-to-br ${
                          item.accent
                        } opacity-70 mix-blend-multiply transition-opacity duration-500 ${
