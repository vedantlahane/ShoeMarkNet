        ...
        <div className="relative z-10 py-6 text-slate-900 dark:text-slate-100">
          <div className="container-app">
            ...
            <div className="relative overflow-hidden rounded-2xl border border-slate-200/50 dark:border-slate-700/50 bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl shadow-lg shadow-slate-900/10 dark:shadow-slate-900/30">
              ...
              <div className="border-b border-slate-200/50 dark:border-slate-700/50 bg-slate-50/50 dark:bg-slate-800/50 backdrop-blur-sm">
                <nav className="flex -mb-px px-2">
                  <button
                    ...
                    className={`relative flex-1 py-4 px-3 text-center font-semibold text-sm transition-all duration-300 rounded-t-lg ${activeTab === 'profile'
                  ...
                  <button
                    ...
                    className={`relative flex-1 py-5 px-4 text-center font-semibold text-sm transition-all duration-300 rounded-t-xl ${activeTab === 'security'
                  ...
                  <button
                    ...
                    className={`relative flex-1 py-5 px-4 text-center font-semibold text-sm transition-all duration-300 rounded-t-xl ${activeTab === 'preferences'
                      ? 'text-white bg-gradient-to-r from-sky-500 via-indigo-500 to-rose-500 shadow-lg'
                      : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-200 hover:bg-white/50 dark:hover:bg-slate-800/50'
                      }`}
              ...
              {activeTab === 'profile' && (
                <>
                  <div className="px-6 py-6 flex justify-between items-center border-b border-slate-200 dark:border-slate-700">
                    <div>
                        ...
                        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                          ...
                          <div className="sm:col-span-1">
                            ...
                            <input
                              ...
                              className={`w-full px-4 py-4 border rounded-xl backdrop-blur-sm transition-all duration-300 ${formTouched.name && !validation.name.isValid
                          ...
                          <div className="sm:col-span-1">
                            ...
                            <input
                              ...
                              className={`w-full px-4 py-4 border rounded-xl backdrop-blur-sm transition-all duration-300 ${formTouched.phone && !validation.phone.isValid
                                ? 'border-red-300/50 bg-red-50/50 dark:bg-red-950/50 text-red-900 dark:text-red-100 placeholder-red-400'
                          ...
                          <div className="sm:col-span-1">
                            ...
                            <input
                              ...
                              className={`w-full px-4 py-4 border rounded-xl backdrop-blur-sm transition-all duration-300 ${formTouched.address && !validation.address.isValid
                                ? 'border-red-300/50 bg-red-50/50 dark:bg-red-950/50 text-red-900 dark:text-red-100 placeholder-red-400'
                          ...
                          <div className="sm:col-span-2">
                            ...
                            <textarea
                              ...
                              className={`w-full px-4 py-4 border rounded-xl backdrop-blur-sm resize-none transition-all duration-300 ${formTouched.bio && !validation.bio.isValid
                                ? 'border-red-300/50 bg-red-50/50 dark:bg-red-950/50 text-red-900 dark:text-red-100 placeholder-red-400'
                                : 'border-slate-200/50 dark:border-slate-700/50 bg-white/50 dark:bg-slate-800/50 text-slate-900 dark:text-slate-100 hover:bg-white/70 dark:hover:bg-slate-800/70 focus:bg-white dark:focus:bg-slate-900 focus:border-sky-400 dark:focus:border-sky-500'
                                }`}
                  ...
                  <div className="px-6 py-6 flex justify-between items-center border-b border-gray-100">
                    ...
                    {!isChangingPassword ? (
                      ...
                      <button
                        ...
                        className="inline-flex items-center px-4 py-2 border border-slate-300 dark:border-slate-600 text-sm font-medium rounded-lg text-slate-700 dark:text-slate-300 bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200"
                      ...
                      <form onSubmit={handlePasswordSubmit} className="space-y-6" noValidate>
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-200 ${passwordTouched.currentPassword && !passwordValidation.currentPassword.isValid
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-200 ${passwordTouched.newPassword && !passwordValidation.newPassword.isValid
                              ? 'border-red-300 bg-red-50'
                              : 'border-gray-300 hover:border-gray-400 focus:border-transparent'
                              }`}
                            aria-required="true"
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-200 ${passwordTouched.confirmPassword && !passwordValidation.confirmPassword.isValid
                              ? 'border-red-300 bg-red-50'
                              : 'border-gray-300 hover:border-gray-400 focus:border-transparent'
                              }`}
                            aria-required="true"
                        ...
                        <div className="flex justify-end space-x-4 pt-6 border-t border-gray-100">
                          <button
                            type="button"
                            onClick={handlePasswordCancel}
                            className="px-6 py-3 border border-slate-300 dark:border-slate-600 rounded-lg text-sm font-medium text-slate-700 dark:text-slate-300 bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200"
                          >
                            Cancel
                          </button>
                          <button
